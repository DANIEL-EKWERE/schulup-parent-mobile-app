...
AcademicsCbtTestTestResultController controller = Get.put(
  AcademicsCbtTestTestResultController(),
);

class AcademicsCbtTestTestResultScreen extends StatefulWidget {
  const AcademicsCbtTestTestResultScreen({Key? key}) : super(key: key);

  @override
  State<AcademicsCbtTestTestResultScreen> createState() =>
      _AcademicsCbtTestTestResultScreenState();
}

class _AcademicsCbtTestTestResultScreenState
    extends State<AcademicsCbtTestTestResultScreen> {
  void initState() {
    super.initState();
    getValue();
  }
  ...
  void getValue() {
    var id = Get.arguments['id'].toString();
