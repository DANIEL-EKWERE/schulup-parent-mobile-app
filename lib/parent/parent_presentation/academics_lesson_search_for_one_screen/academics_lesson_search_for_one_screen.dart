...
class AcademicsLessonSearchForOneScreen
    extends GetWidget<AcademicsLessonSearchForOneController> {
  const AcademicsLessonSearchForOneScreen({Key? key}) : super(key: key);
    ...
    return Expanded(
      child: Obx(
        () => ListView.separated(
          ...
          itemCount:
              controller
                  .academicsLessonSearchForOneModelObj
                  .value
                  .listlineItemList
                  .value
                  .length,
