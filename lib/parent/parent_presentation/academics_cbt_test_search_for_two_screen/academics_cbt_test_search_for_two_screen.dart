...
import 'controller/academics_cbt_test_search_for_two_controller.dart'; // ignore_for_file: must_be_immutable

class AcademicsCbtTestSearchForTwoScreen
    extends GetWidget<AcademicsCbtTestSearchForTwoController> {
  const AcademicsCbtTestSearchForTwoScreen({Key? key}) : super(key: key);
