...
class CustomSearchView extends StatelessWidget {
  ...
  InputDecoration get decoration => InputDecoration(
    ...
    prefixIconConstraints: prefixConstraints ?? BoxConstraints(maxHeight: 38.h),
    suffixIcon:
        suffix ??
        Padding(
    ...
    suffixIconConstraints: suffixConstraints ?? BoxConstraints(maxHeight: 38.h),
    isDense: true,
    ...
    focusedBorder: (borderDecoration ??
            OutlineInputBorder(borderRadius: BorderRadius.circular(18.h)))
        .copyWith(
