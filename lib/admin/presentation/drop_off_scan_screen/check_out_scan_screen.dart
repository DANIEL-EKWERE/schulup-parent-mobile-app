...
class CheckOutScanScreen extends GetWidget<DropOffScanController> {
  const CheckOutScanScreen({Key? key}) : super(key: key);
              ...
              ? Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // ),
                    Obx(() {
                      return controller.isCheckOutScanning.value
                          ? Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomElevatedButton(
                      ...
                      onPressed: () {
                        //onTapScan();
                        controller.isCheckOutScanning.value = true;
