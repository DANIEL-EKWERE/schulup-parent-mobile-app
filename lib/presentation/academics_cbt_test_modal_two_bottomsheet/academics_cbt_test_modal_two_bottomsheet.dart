...
import 'controller/academics_cbt_test_modal_two_controller.dart';

// ignore_for_file: must_be_immutable
class AcademicsCbtTestModalTwoBottomsheet extends StatelessWidget {
  AcademicsCbtTestModalTwoBottomsheet(this.controller, {Key? key})
    : super(key: key);

  AcademicsCbtTestModalTwoController controller;
