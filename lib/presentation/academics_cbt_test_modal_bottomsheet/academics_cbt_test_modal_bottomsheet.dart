...
import 'controller/academics_cbt_test_modal_controller.dart';

// ignore_for_file: must_be_immutable
class AcademicsCbtTestModalBottomsheet extends StatelessWidget {
  AcademicsCbtTestModalBottomsheet(this.controller, {Key? key})
    : super(key: key);

  AcademicsCbtTestModalController controller;
