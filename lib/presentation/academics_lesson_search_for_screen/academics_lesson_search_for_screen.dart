...
import 'controller/academics_lesson_search_for_controller.dart'; // ignore_for_file: must_be_immutable

class AcademicsLessonSearchForScreen
    extends GetWidget<AcademicsLessonSearchForController> {
  const AcademicsLessonSearchForScreen({Key? key}) : super(key: key);
          ...
          CustomAppBar(
            ...
            title: SizedBox(
              ...
              child: AppbarTitleSearchview(
                ...
                hintText: "msg_search_for_a_lesson".tr,
