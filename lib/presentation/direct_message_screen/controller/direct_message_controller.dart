...
class ChatController extends GetxController {
  ...
  void _initializeSignalR() async {
    ...
    final baseUrl = 'https://api.schulup.com/api'; // Your API base URL
  ...
  void _setupEventListeners() {
    ...
    _connectionSubscription = _signalRService.onConnectionStateChanged.listen((state) {
  ...
  void _updateConversationWithNewMessage(ChatMessage message) {
    ...
    if (index != -1) {
      ...
      conversations[index] = Conversation(
        ...
        unreadCount: message.conversationId == currentConversationId.value 
          ? 0 
          : conv.unreadCount + 1,
  ...
  /// Send message
  Future<void> sendMessage(String content, {List<String>? attachmentIds}) async {
