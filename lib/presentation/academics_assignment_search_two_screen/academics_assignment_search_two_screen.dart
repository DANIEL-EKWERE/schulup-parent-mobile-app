...
import 'controller/academics_assignment_search_two_controller.dart'; // ignore_for_file: must_be_immutable

class AcademicsAssignmentSearchTwoScreen
    extends GetWidget<AcademicsAssignmentSearchTwoController> {
  const AcademicsAssignmentSearchTwoScreen({Key? key}) : super(key: key);
                  ...
                  child: Row(
                    children: [
                      CustomDropDown(
                        ...
                        items:
                            controller
                                .academicsAssignmentSearchTwoModelObj
                                .value
                                .dropdownItemList!
                                .value,
