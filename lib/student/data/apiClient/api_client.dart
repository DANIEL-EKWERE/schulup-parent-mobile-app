...
import 'package:schulupparent/student/core/utils/snackbar_utils.dart';
...
class ApiClient extends GetConnect {
  ...
  // get termly report
  Future<http.Response> getTermlyReport(
    String studentID,
  ...
  // get weekly report
  Future<http.Response> getWeeklyReport(
    String studentID,
    String academicSessionId,
    String termId,
  ) async {
  ...
  Future<http.Response> getSubjectProgress(
    String studentID,
    String subjectID,
  ) async {
    final url = Uri.parse(
