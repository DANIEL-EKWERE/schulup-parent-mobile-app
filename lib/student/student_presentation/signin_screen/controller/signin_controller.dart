  ...
  Future<void> firstLogin() async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        studentDataBase.saveToken(token);
        studentDataBase.saveUserId(userId);
        studentDataBase.saveUserName(userName);
        studentDataBase.saveTransactionPin(passwordController.text);
        studentDataBase.saveBrmCode(schoolCodeController.text);
