...
import 'package:signalr_netcore3/hub_connection.dart';
import 'package:signalr_netcore3/signalr_client.dart';

class StudentSignalRChatService {
  ...
  StudentSignalRChatService({required this.baseUrl, required this.token});
  ...
  //         myLog.log(message, name: 'StudentSignalRChatService', level: 800);
  //     void _logWarning(String message, [Object? error]) => myLog.log(
  //       message,
  //       name: 'StudentSignalRChatService',
  //       level: 900,
  //       error: error,
  //     );
