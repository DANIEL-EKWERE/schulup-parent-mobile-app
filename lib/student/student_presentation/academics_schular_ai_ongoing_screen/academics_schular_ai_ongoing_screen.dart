...
//                                     ),
//                               ),
//                               //Text(textMessage.author.firstName!),
//                             ],
//                           ),
//                         )
//                         : SizedBox(
...
StudentAcademicsSchularAiOngoingController controller = Get.put(
  StudentAcademicsSchularAiOngoingController(),
);

class StudentAcademicsSchularAiOngoingScreen extends StatelessWidget {
              ...
              child: SizedBox(
                ...
                child: Chat(
                        ...
                        ? Column(
                          children: [
                            ...
                            Align(
                              ...
                              child: Text(
                                '${dashboardExtendedViewController.selectedStudent1!.firstName!} • ${_formatTimestamp(message.createdAt)}',
                              ),
                            ),
                          ],
                        )
                        : Column(
                          children: [
                            ...
                            Align(
                              ...
                              child: Text(
                                'Scholar AI • ${_formatTimestamp(message.createdAt)}',
                  ...
                  textMessageBuilder: (
                    ...
                    bool isUserMessage =
                        textMessage.author.id == controller.chatUser.value.id;
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration:
                                    isUserMessage
                                        ...
                                        : AppDecoration.accentC4.copyWith(
                                          borderRadius:
                                              BorderRadiusStyle
                                                  .customBorderBL10,
                                        ),
                              ...
                              //     left: isUserMessage ? 0 : 4.h,
                              //     right: isUserMessage ? 4.h : 0,
                              //   ),
                              //   child: Text(
                              //     isUserMessage
                              //         ? '${dashboardExtendedViewController.selectedStudent1!.firstName!} • ${_formatTimestamp(textMessage.createdAt)}'
                              //         : 'Scholar AI • ${_formatTimestamp(textMessage.createdAt)}',
                              //     style: CustomTextStyles.bodySmall10_1,
                              //     textAlign:
                              //         isUserMessage
...
// ### 1. **Unified Message Layout**
// Both user and AI messages now have the same structure:
// ```
// ┌─────────────────┐
// │  Message Bubble │
// └─────────────────┘
